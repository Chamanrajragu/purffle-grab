...
**Download Spotify playlists, YouTube videos, and music to MP3, MP4, FLAC, or 4K — free, ad-free, open-source.**
...
[![CI](https://img.shields.io/github/actions/workflow/status/Chamanrajragu/purffle-grab/ci.yml?style=flat-square&label=CI)](https://github.com/Chamanrajragu/purffle-grab/actions)
...
### ⭐ Star this repo if you find it useful! &nbsp;·&nbsp; 🌐 [**Visit the website →**](https://chamanrajragu.github.io/purffle-grab/)
...
1. **Paste a link** — a Spotify or YouTube URL (one or many, one per line, or import from file).
2. **Click Analyze** — PurffleGrab reads the video/track list.
3. **Pick options** — video or audio, quality, format; use presets or customize.
...
Yes — completely free and open-source under MIT. No ads, no accounts, no limits.</details>
